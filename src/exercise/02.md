...
I tried to create the root element by React.create(), it did not work :)
ReactDOM only accepts HtmlDOMElement as a root element not a ReactElement.

I understand better the differences between declarative and imperative programming styles. Really appreciate the blog post it was so great. I'll look ui.dev resources later.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=han.tuerker%40gmail.com).
